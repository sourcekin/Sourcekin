...
final class Attribute
{
    ...
    public function withName(Name $name): Attribute
    {
        return new self($name, $this->content);
    }

    public function withContent(string $content): Attribute
    {
        return new self($this->name, $content);
    }

    public static function fromArray(array $data): Attribute
    {
    ...
    {
        if (\get_class($this) !== \get_class($attribute)) {
            return false;
        }

        return $this->name->toString() === $attribute->name->toString()
